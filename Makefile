...
LINKOPTS    := -pthread -L${CAFFEDIR}/lib -L${OPENCVDIR}/lib -L${HDFDIR}/lib -lcaffe -lglog -lgflags -lleveldb -llmdb -lopenblas -lprotobuf -lsnappy -lopencv_core -lopencv_highgui -lopencv_imgcodecs -lopencv_imgproc -lz -lpthread -lboost_filesystem -lboost_system -lboost_thread -lboost_mpi -Wl,-rpath=./libs
